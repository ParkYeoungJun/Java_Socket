...
public class MainFrame /*extends JFrame*/{
	...
	public static void main(String args[])
	{
		...
		c.setBackground(new Color(239, 238, 252));
	...
	//	id.setBackground(new Color(173, 227, 255));
		...
		loginBtn.setBackground(new Color(254, 199, 220));
	...
	public MainFrame()
	{
		...
		mainf.addWindowListener(new WindowAdapter(){
			public void windowClosing(WindowEvent e)
			{
				...
				c1.setBackground(new Color(239, 238, 252));
				...
				yes.setBackground(new Color(254, 199, 220));
				no.setBackground(new Color(254, 199, 220));
