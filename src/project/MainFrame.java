...
public class MainFrame /*extends JFrame*/{
   ...
   public static void main(String args[])
   {
      ...
      login.setBounds(800, 400, 300, 150);
      login.setLayout(null);
      login.setIconImage(new ImageIcon("icon.png").getImage());
      Container c = login.getContentPane();
      c.setBackground(new Color(194, 233, 224));
      
      JLabel nick = new JLabel("닉네임을 입력해 주세요.");
      nick.setBounds(55, 15, 180, 30);
      nick.setFont(new Font("함초롬돋움", Font.PLAIN, 16));
      login.add(nick);
   ...
   //   id.setBackground(new Color(173, 227, 255));
      login.add(id);
      
      loginBtn.setBounds(195, 60, 60, 30);
   ...
   public MainFrame()
   {
      ...
      mainf.setIconImage(new ImageIcon("icon.png").getImage());
      Container c = mainf.getContentPane();
      c.setBackground(new Color(194, 233, 224));
      ...
      mainf.addWindowListener(new WindowAdapter(){
         public void windowClosing(WindowEvent e)
         {
            ...
            close.setBounds(fulldim.width/2-100,fulldim.height/2-100,300,150);
            close.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
            close.setIconImage(new ImageIcon("icon.png").getImage());
            Container c1 = close.getContentPane();
            c1.setBackground(new Color(194, 233, 224));
            JLabel la = new JLabel("종료하시겠습니까?");
            la.setFont(new Font("함초롬돋움", Font.PLAIN, 14));
            la.setBounds(80,15,180,40);
            close.add(la);
            ...
            yes.setFont(new Font("함초롬돋움", Font.PLAIN, 12));
            no.setFont(new Font("함초롬돋움", Font.PLAIN, 12));
            yes.setBounds(40, 60, 70, 30);
            no.setBounds(170, 60, 70, 30);
            close.add(yes);
            close.add(no);
      ...
      Lchat = new JTextArea();
      Lchat.setFont(new Font("함초롱바탕", Font.PLAIN, 12));
      Lchat.setEditable(false);
      Lchat.setLineWrap(true);
      Lchatscroll = new JScrollPane(Lchat);
      Lchatscroll.setBounds(fulldim.width - 320, 70, fulldim.width - 1620, fulldim.height - 290);      
      ...
      //fulldim.width-1705, fulldim.height-1120
      chatscroll.setBounds(fulldim.width - 320, fulldim.height - 210, 220, 100);
      mainf.add(chatscroll);

      
      passtextBtn = new JButton(new ImageIcon("send.png"));
   //   passtextBtn.setBackground(new Color(254, 199, 220));
      passtextBtn.setFont(new Font("함초롬돋움", Font.PLAIN, 12));
      passtextBtn.setBounds(fulldim.width - 100, fulldim.height - 210, 80, 80);
      ...
      Screen.setBounds(30, 70, fulldim.width-380 , fulldim.height - 200);
      ...
      clientsize.setFont(new Font("함초롬돋움", Font.PLAIN, 16));
      clientsize.setBounds(fulldim.width-320, 40, 100, 20);
   ...
   private synchronized void addMessage(String msg)
   {
      ...
      {         
         ...
         clientsize.setFont(new Font("함초롱바탕", Font.BOLD, 16));
         clientsize.setText("접속자 수 : " + tempstr[1]);
         clientsize.setFont(new Font("함초롱바탕", Font.PLAIN, 12));
      }
      ...
      else if(msg.contains("/silent"))
      {
         ...
         if(user.equals(tempstr[2]))
         {
            ...
            chatting.setFont(new Font("함초롱바탕", Font.BOLD, 16));
            chatting.setText("뻐끔이 처리 되었습니다.");         
            sendMessage("["+user+"]가 뻐끔이 처리 되었습니다.\n");
            clientsize.setFont(new Font("함초롱바탕", Font.PLAIN, 12));
            
            JOptionPane.showMessageDialog(null, "뻐끔이 처리 되었습니다.");
      ...
      else if(msg.contains("/startvote"))
      {
         ...
         else
         {
            ...
            Lchat.setFont(new Font("함초롱바탕", Font.BOLD, 16));
            Lchat.setForeground(new Color(255, 0, 0));
            Lchat.append("<<<<<< 투표를 시작합니다 >>>>>>\n\n"+str+"\n\n찬성하신다면 /vote yes\n"+"반대하신다면 /vote no\n를 입력하세요\n\n");
            Lchat.append("투표종료는 방장이 /endvote를 입력하였을 때 종료됩니다.");
            Lchat.setForeground(new Color(0, 0, 0));
            Lchat.setFont(new Font("함초롱바탕", Font.PLAIN, 12));
